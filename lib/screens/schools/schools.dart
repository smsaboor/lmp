...
import 'package:lakhimpur_kheri/screens/schools/row.dart';
//import 'package:flutter_uikit/ui/widgets/login_background.dart';
import 'package:lakhimpur_kheri/screens/schools/profile_tile.dart';
      ...
      child: Padding(
        ...
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              DashboardMenuRow(
                firstIcon: FontAwesomeIcons.solidNewspaper,
                firstLabel: "News",
