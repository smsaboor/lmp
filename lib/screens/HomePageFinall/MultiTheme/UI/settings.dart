...
class SettingNew extends StatefulWidget {
  SettingNew({Key key, this.title, this.model}) : super(key: key);
  final String title;
  ThemeModel model;
  @override
  _SettingNewState createState() => _SettingNewState();
}

class _SettingNewState extends State<SettingNew> with SingleTickerProviderStateMixin {
